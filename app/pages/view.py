...
from app.core.components.frayer import (
    render_frayer_model,
...
def render_sidebar(word) -> dict:
    ...
    with st.sidebar:
        ...
        options = {
            "show_word_title": st.checkbox(
                "Word", value=True, key="show_word"
            ),
            ...
            "show_examples": st.checkbox(
                "Examples", value=True, key="show_examples"
            ),
...
def main():
    ...
    st.caption(f"Subject: **{word.subject.name}**")
